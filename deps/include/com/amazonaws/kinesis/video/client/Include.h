...
// Minimal type stub — CONTENT_VIEW_OVERFLOW_POLICY is from view/Include.h,
// referenced in struct StreamCaps below but not used by WebRTC code.
#ifndef __KINESIS_VIDEO_VIEW_INCLUDE__
