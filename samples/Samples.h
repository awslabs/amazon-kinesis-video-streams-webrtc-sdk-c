...
/* Single TURN server for the presigned mode */
#define KVS_PRESIGNED_TURN_URI      ((PCHAR) "KVS_PRESIGNED_TURN_URI")
#define KVS_PRESIGNED_TURN_USERNAME ((PCHAR) "KVS_PRESIGNED_TURN_USERNAME")
#define KVS_PRESIGNED_TURN_PASSWORD ((PCHAR) "KVS_PRESIGNED_TURN_PASSWORD")
...
STATUS createSampleConfiguration(PCHAR, SIGNALING_CHANNEL_ROLE_TYPE, BOOL, BOOL, UINT32, BOOL, PSampleConfiguration*);
