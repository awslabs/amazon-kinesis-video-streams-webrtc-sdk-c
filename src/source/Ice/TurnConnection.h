...
// turn state timeouts
#define DEFAULT_TURN_SOCKET_CONNECT_TIMEOUT    (10 * HUNDREDS_OF_NANOS_IN_A_SECOND)
#define DEFAULT_TURN_GET_CREDENTIAL_TIMEOUT    (10 * HUNDREDS_OF_NANOS_IN_A_SECOND)
#define DEFAULT_TURN_ALLOCATION_TIMEOUT        (10 * HUNDREDS_OF_NANOS_IN_A_SECOND)
#define DEFAULT_TURN_CREATE_PERMISSION_TIMEOUT (10 * HUNDREDS_OF_NANOS_IN_A_SECOND)
#define DEFAULT_TURN_BIND_CHANNEL_TIMEOUT      (10 * HUNDREDS_OF_NANOS_IN_A_SECOND)
