 ...
 */
#define ICE_AGENT_STATE_NONE             ((UINT64) 0) // 0
#define ICE_AGENT_STATE_NEW              ((UINT64) (1 << 0)) // 1
#define ICE_AGENT_STATE_CHECK_CONNECTION ((UINT64) (1 << 1)) // 2
#define ICE_AGENT_STATE_CONNECTED        ((UINT64) (1 << 2)) // 4
#define ICE_AGENT_STATE_NOMINATING       ((UINT64) (1 << 3)) // 8
#define ICE_AGENT_STATE_READY            ((UINT64) (1 << 4)) // 16 --> 0x10
#define ICE_AGENT_STATE_DISCONNECTED     ((UINT64) (1 << 5)) // 32 --> 0x20
#define ICE_AGENT_STATE_FAILED           ((UINT64) (1 << 6)) // 64  --> 0x40
