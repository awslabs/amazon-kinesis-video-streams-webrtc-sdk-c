...
#define ICE_AGENT_STATE_CHECK_CONNECTION                ((UINT64) (1 << 2))
#define ICE_AGENT_STATE_CONNECTED                       ((UINT64) (1 << 3))
#define ICE_AGENT_STATE_NOMINATING                      ((UINT64) (1 << 4))
#define ICE_AGENT_STATE_READY                           ((UINT64) (1 << 5))
#define ICE_AGENT_STATE_DISCONNECTED                    ((UINT64) (1 << 6))
#define ICE_AGENT_STATE_FAILED                          ((UINT64) (1 << 7))
...
STATUS iceAgentStateMachineReportStateChange(PIceAgent, UINT64, UINT64);
