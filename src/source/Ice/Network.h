...
// excluding null-terminator (included in KVS_IP_ADDRESS_STRING_BUFFER_LEN)
#define KVS_IPV6_ADDRESS_DECORATOR_STR_LEN 8

#define KVS_IP_ADDRESS_PORT_STRING_BUFFER_LEN (KVS_IP_ADDRESS_STRING_BUFFER_LEN + KVS_IPV6_ADDRESS_DECORATOR_STR_LEN)
