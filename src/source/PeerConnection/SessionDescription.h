...
#define RTC_RTP_TRANSCEIVER_DIRECTION_SENDRECV_STRLEN 8
#define RTC_RTP_TRANSCEIVER_DIRECTION_SENDONLY_STRLEN 8
#define RTC_RTP_TRANSCEIVER_DIRECTION_RECVONLY_STRLEN 8
#define RTC_RTP_TRANSCEIVER_DIRECTION_INACTIVE_STRLEN 8
