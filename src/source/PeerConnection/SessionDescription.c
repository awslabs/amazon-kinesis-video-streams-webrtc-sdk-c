                                  ...
                                  PHashTable pUnknownCodecRtpmapTable, UINT32 unknownCodecHashTableKey)
{
    ...
    if (pRtcMediaStreamTrack->kind == MEDIA_STREAM_TRACK_KIND_VIDEO) {
        ...
        if (containRtx) {
            SNPRINTF(pSdpMediaDescription->mediaName, SIZEOF(pSdpMediaDescription->mediaName), "video 9 UDP/TLS/RTP/SAVPF %" PRId64 " %" PRId64,
