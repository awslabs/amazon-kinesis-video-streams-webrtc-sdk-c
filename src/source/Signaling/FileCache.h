...
#define MAX_SERIALIZED_SIGNALING_CACHE_ENTRY_LEN        MAX_CHANNEL_NAME_LEN + MAX_ARN_LEN + MAX_REGION_NAME_LEN + \
                                                        MAX_SIGNALING_ENDPOINT_URI_LEN * 2 + \
                                                        MAX_SIGNALING_CACHE_ENTRY_TIMESTAMP_STR_LEN + 8
