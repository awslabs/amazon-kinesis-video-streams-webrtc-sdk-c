...
StateMachineState SIGNALING_STATE_MACHINE_STATES[] = {
    ...
    {SIGNALING_STATE_GET_TOKEN,
     SIGNALING_STATE_NEW | SIGNALING_STATE_DESCRIBE | SIGNALING_STATE_DESCRIBE_MEDIA | SIGNALING_STATE_CREATE | SIGNALING_STATE_GET_ENDPOINT |
         ...
         SIGNALING_STATE_DELETE | SIGNALING_STATE_GET_TOKEN,
    ...
    {SIGNALING_STATE_GET_ICE_CONFIG,
     SIGNALING_STATE_DESCRIBE | SIGNALING_STATE_DESCRIBE_MEDIA | SIGNALING_STATE_CONNECT | SIGNALING_STATE_CONNECTED | SIGNALING_STATE_JOIN_SESSION |
         SIGNALING_STATE_JOIN_SESSION_WAITING | SIGNALING_STATE_JOIN_SESSION_CONNECTED | SIGNALING_STATE_GET_ENDPOINT | SIGNALING_STATE_READY |
         SIGNALING_STATE_GET_ICE_CONFIG,
    ...
    {SIGNALING_STATE_JOIN_SESSION_WAITING, SIGNALING_STATE_JOIN_SESSION_WAITING | SIGNALING_STATE_JOIN_SESSION, fromJoinStorageSessionWaitingState,
     executeJoinStorageSessionWaitingState, defaultSignalingStateTransitionHook, INFINITE_RETRY_COUNT_SENTINEL,
