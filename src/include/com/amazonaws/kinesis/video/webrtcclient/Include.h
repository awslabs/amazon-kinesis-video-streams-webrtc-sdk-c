...
#define STATUS_SDP_UNKNOWN_ERROR                          STATUS_SDP_BASE + 0x00000010
#define STATUS_SDP_BAD_PARAM                              STATUS_SDP_BASE + 0x00000011
#define STATUS_SDP_MESSAGE_MALFORMED                      STATUS_SDP_BASE + 0x00000012
#define STATUS_SDP_MESSAGE_MALFORMED_NOT_ENOUGH_INFO      STATUS_SDP_BASE + 0x00000013
#define STATUS_SDP_MESSAGE_MALFORMED_EQUAL_NOT_FOUND      STATUS_SDP_BASE + 0x00000014
#define STATUS_SDP_MESSAGE_MALFORMED_NEWLINE_NOT_FOUND    STATUS_SDP_BASE + 0x00000015
#define STATUS_SDP_MESSAGE_MALFORMED_NO_VALUE             STATUS_SDP_BASE + 0x00000016
#define STATUS_SDP_MESSAGE_MALFORMED_NO_SESSION_ID        STATUS_SDP_BASE + 0x00000017
#define STATUS_SDP_MESSAGE_MALFORMED_NO_SESSION_VERSION   STATUS_SDP_BASE + 0x00000018
#define STATUS_SDP_MESSAGE_MALFORMED_INVALID_NETWORK_TYPE STATUS_SDP_BASE + 0x00000019
#define STATUS_SDP_MESSAGE_MALFORMED_INVALID_ADDRESS_TYPE STATUS_SDP_BASE + 0x0000001A
#define STATUS_SDP_MESSAGE_MALFORMED_REDUNDANT_INFO       STATUS_SDP_BASE + 0x0000001B
#define STATUS_SDP_MESSAGE_MALFORMED_INVALID_BANDWIDTH    STATUS_SDP_BASE + 0x0000001C
#define STATUS_SDP_MESSAGE_MALFORMED_INVALID_START_TIME   STATUS_SDP_BASE + 0x0000001D
#define STATUS_SDP_MESSAGE_MALFORMED_INVALID_STOP_TIME    STATUS_SDP_BASE + 0x0000001E
#define STATUS_SDP_MESSAGE_MALFORMED_INVALID_PORT         STATUS_SDP_BASE + 0x0000001F
#define STATUS_SDP_MESSAGE_MALFORMED_INVALID_PORTNUM      STATUS_SDP_BASE + 0x00000020
#define STATUS_SDP_SNPRINTF_ERROR                         STATUS_SDP_BASE + 0x00000021
/*!@} */
