...
/*! \addtogroup SessionDescriptionInitStatusCodes_0x550000xx
...
/**
 * @brief The incoming session description is not a JSON object.
 * @par Recommended action:
 * Ensure the SDP sent by the other peer is of JSON type
 */
...
/**
 * @brief The received session description is neither an offer nor an answer
 * @par Recommended action:
 * Ensure the SDP generated by the other peer is either offer/answer/ICE candidate
 */
#define STATUS_SESSION_DESCRIPTION_INIT_INVALID_TYPE STATUS_WEBRTC_BASE + 0x00000003

/**
 * @brief The received session description is not an offer/answer/ICE candidate
 * @par Recommended action:
 * Ensure the SDP generated by the other peer is either an offer/answer type
 */
#define STATUS_SESSION_DESCRIPTION_INIT_MISSING_SDP STATUS_WEBRTC_BASE + 0x00000004

/**
 * @brief The status code is set if the SDP type is not offer/answer. This status code is masked by STATUS_SESSION_DESCRIPTION_INIT_INVALID_TYPE.
 * @par Recommended action:
 * Ensure the SDP generated by the other peer is either an offer/answer type
 */
...
/**
 * @brief Maximum SDP length supported by the SDK is 25000 bytes
 * @par Recommended action:
 * Investigate the SDP to understand the contents. Some of the common contributors noticed are multiple supported audio/video codecs and large number
 * of ICE candidates.
 */
#define STATUS_SESSION_DESCRIPTION_INIT_MAX_SDP_LEN_EXCEEDED STATUS_WEBRTC_BASE + 0x00000006

/**
 * @brief Indicates session description received from remote peer is NULL
 * @par Recommended action:
 * This is an internal status code. If a valid session PRtcSessionDescriptionInit is passed into setRemoteDescription, please send logs to the service
 * team
 */
...
/**
 * @brief The certificate fingerprint is required when setting up srtp with DTLS. The status code indicates that the `fingerprint` SDP attribute from
...
/**
 * @brief Indicates that the number of transceivers added is more than 5.
 * @par Recommended action:
 * Ensure that not more than 5 transceivers are added as part of `addTransceiver()` call
 */
...
/*! \addtogroup SDPStatusCodes_0x560000xx
...
/*! \addtogroup STUNStatusCodes_0x570000xx
...
/*! \addtogroup NetworkingStatusCodes_0x580000xx
 * WEBRTC Networking related codes. Values are derived from STATUS_NETWORKING_BASE
 *  @{
 */
...
/*! \addtogroup DTLSStatusCodes_0x590000xx
 * WEBRTC DTLS related codes. Values are derived from STATUS_DTLS_BASE
 *  @{
 */
...
/*! \addtogroup ICEStatusCodes_0x5a0000xx
...
/*! \addtogroup SRTPStatusCodes_0x5b0000xx
 * WEBRTC SRTP related codes. Values are derived from STATUS_SRTP_BASE
 *  @{
 */
...
/*! \addtogroup RTPStatusCodes_0x5c0000xx
 * WEBRTC RTP related codes. Values are derived from STATUS_RTP_BASE
 *  @{
 */
...
/*! \addtogroup SignalingStatusCodes_0x5d0000xx
 * WEBRTC Signaling related codes. Values are derived from STATUS_SIGNALING_BASE
 *  @{
 */
...
/*! \addtogroup PeerConnectionStatusCodes_0x5e0000xx
...
/*! \addtogroup SCTPStatusCodes_0x5f0000xx
 * WEBRTC SCTP related codes. Values are derived from STATUS_SCTP_BASE
 *  @{
 */
...
/*! \addtogroup RTCPStatusCodes_0x600000xx
 * WEBRTC RTCP related codes. Values are derived from STATUS_RTCP_BASE
 *  @{
 */
...
/*! \addtogroup RollingBufferStatusCodes_0x610000xx
