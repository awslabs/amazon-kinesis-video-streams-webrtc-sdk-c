 ...
 */
PUBLIC_API STATUS getRtcPeerConnectionStats(PRtcPeerConnection, PRTCStats);
 ...
 */
PUBLIC_API STATUS getSignalingClientStats(SIGNALING_CLIENT_HANDLE, PSignalingClientMetrics);
