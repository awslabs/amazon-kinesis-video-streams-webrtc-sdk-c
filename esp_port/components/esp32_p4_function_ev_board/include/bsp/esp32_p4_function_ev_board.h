...
#elif CONFIG_BSP_BOARD_TYPE_SAMPLE_V10B
#define BSP_I2C_SCL             (GPIO_NUM_34)
#define BSP_I2C_SDA             (GPIO_NUM_31)
#elif CONFIG_BSP_BOARD_TYPE_SAMPLE_V12
#define BSP_I2C_SCL             (GPIO_NUM_8)
#define BSP_I2C_SDA             (GPIO_NUM_7)
#endif
...
/* Audio */
#if CONFIG_BSP_BOARD_TYPE_FLY_LINE || CONFIG_BSP_BOARD_TYPE_SAMPLE_V10B
...
#elif CONFIG_BSP_BOARD_TYPE_FIB || CONFIG_BSP_BOARD_TYPE_SAMPLE_V12
...
#if CONFIG_BSP_BOARD_TYPE_FLY_LINE || CONFIG_BSP_BOARD_TYPE_SAMPLE_V10B || CONFIG_BSP_BOARD_TYPE_SAMPLE_V12
