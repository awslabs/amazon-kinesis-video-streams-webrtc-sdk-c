...
const string CONTAINER_LOG_DIRECTORY = "/tmp/test-logs/";
...
const string SETUP_MOCK_DATA_PLANE_SERVER_SCRIPT = SCRIPTS_ROOT + "/setup_mock_dataplane_server.sh";
...
const string DOCKER_EXEC_COMMAND = "docker exec --privileged -it ";
...
const string SIGNALING_SERVER_PROTOCOL_PREFIX = "http://";
const string KILL_SIGNALING_DP_SERVER_PROCESS = "pkill -9 python3";
